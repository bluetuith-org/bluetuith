...
const (
	SdpServerServiceClass          = 0x1000
	BrowseGrpDescServiceClass      = 0x1001
	PublicBrowseGroup              = 0x1002
	SerialPortServiceClass         = 0x1101
	LanAccessServiceClass          = 0x1102
	DialupNetServiceClass          = 0x1103
	IrmcSyncServiceClass           = 0x1104
	ObexObjpushServiceClass        = 0x1105
	ObexFiletransServiceClass      = 0x1106
	IrmcSyncCmdServiceClass        = 0x1107
	HeadsetServiceClass            = 0x1108
	CordlessTelephonyServiceClass  = 0x1109
	AudioSourceServiceClass        = 0x110a
	AudioSinkServiceClass          = 0x110b
	AvRemoteTargetServiceClass     = 0x110c
	AdvancedAudioServiceClass      = 0x110d
	AvRemoteServiceClass           = 0x110e
	AvRemoteControllerServiceClass = 0x110f
	IntercomServiceClass           = 0x1110
	FaxServiceClass                = 0x1111
	HeadsetAgwServiceClass         = 0x1112
	WapServiceClass                = 0x1113
	WapClientServiceClass          = 0x1114
	PanuServiceClass               = 0x1115
	NapServiceClass                = 0x1116
	GnServiceClass                 = 0x1117
	DirectPrintingServiceClass     = 0x1118
	ReferencePrintingServiceClass  = 0x1119
	ImagingServiceClass            = 0x111a
	ImagingResponderServiceClass   = 0x111b
	ImagingArchiveServiceClass     = 0x111c
	ImagingRefobjsServiceClass     = 0x111d
	HandsfreeServiceClass          = 0x111e
	HandsfreeAgwServiceClass       = 0x111f
	DirectPrtRefobjsServiceClass   = 0x1120
	ReflectedUIServiceClass        = 0x1121
	BasicPrintingServiceClass      = 0x1122
	PrintingStatusServiceClass     = 0x1123
	HidServiceClass                = 0x1124
	HcrServiceClass                = 0x1125
	HcrPrintServiceClass           = 0x1126
	HcrScanServiceClass            = 0x1127
	CipServiceClass                = 0x1128
	VideoConfGwServiceClass        = 0x1129
	UdiMtServiceClass              = 0x112a
	UdiTaServiceClass              = 0x112b
	AvServiceClass                 = 0x112c
	SapServiceClass                = 0x112d
	PbapPceServiceClass            = 0x112e
	PbapPseServiceClass            = 0x112f
	PbapServiceClass               = 0x1130
	MapMseServiceClass             = 0x1132
	MapMceServiceClass             = 0x1133
	MapServiceClass                = 0x1134
	GnssServiceClass               = 0x1135
	GnssServerServiceClass         = 0x1136
	MpsScServiceClass              = 0x113A
	MpsServiceClass                = 0x113B
	PnpInfoServiceClass            = 0x1200
	GenericNetworkingServiceClass  = 0x1201
	GenericFiletransServiceClass   = 0x1202
	GenericAudioServiceClass       = 0x1203
	GenericTelephonyServiceClass   = 0x1204
	UpnpServiceClass               = 0x1205
	UpnpIPServiceClass             = 0x1206
	UpnpPanServiceClass            = 0x1300
	UpnpLapServiceClass            = 0x1301
	UpnpL2CapServiceClass          = 0x1302
	VideoSourceServiceClass        = 0x1303
	VideoSinkServiceClass          = 0x1304
	VideoDistributionServiceClass  = 0x1305
	HdpServiceClass                = 0x1400
	HdpSourceServiceClass          = 0x1401
	HdpSinkServiceClass            = 0x1402
	GenericAccessServiceClass      = 0x1800
	GenericAttribServiceClass      = 0x1801
	AppleAgentServiceClass         = 0x2112
)
