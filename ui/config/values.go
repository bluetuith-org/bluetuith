...
func (v *ConfigValues) validateValues() error {
...
func (v *ConfigValues) validateSessionValues(session bluetooth.Session) error {
...
func (v *ConfigValues) validateAdapter(session bluetooth.Session) error {
...
func (v *ConfigValues) validateDeviceExists(session bluetooth.Session) error {
...
func (v *ConfigValues) validateKeybindings() error {
...
func (v *ConfigValues) validateAdapterStates() error {
	if v.AdapterStates == "" {
		return nil
	}
...
func (v *ConfigValues) validateConnectBDAddr() error {
	if v.ConnectAddr == "" {
		return nil
	}
...
func (v *ConfigValues) validateReceiveDir() error {
	if v.ReceiveDir == "" {
		return nil
	}
...
func (v *ConfigValues) validateGsm() error {
...
func (v *ConfigValues) validateTheme() error {
	if len(v.Theme) == 0 {
		return nil
	}
