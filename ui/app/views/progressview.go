...
func (p *progressView) suspendTransfer() {
	transferProps, progress := p.getData()
...
// getData gets the file transfer properties and the progress data
// from the current selection in the progress view.
func (p *progressView) getData() (bluetooth.FileTransferData, *progressIndicator) {
