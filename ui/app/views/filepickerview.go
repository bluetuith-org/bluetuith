...
// filePickerView describes a filepicker.
...
func (f *filePickerView) filePickerButtons() *tview.TextView {
	...
	f.buttons.SetHighlightedFunc(func(added, removed, remaining []string) {
		if added == nil {
			return
		}
...
func (f *filePickerView) cellHandler(table *tview.Table, row, col int) {
