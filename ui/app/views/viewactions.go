...
// the action context.
func (v *viewActions) handler(key keybindings.Key, context viewActionContext) func() bool {
	handler := v.fnmap[context][key]

	if context == actionInvoke {
		return func() bool {
			go handler()
			return false
		}
...
func (v *viewActions) power(set ...string) bool {
	...
	v.rv.menu.setItemToggle(keybindings.KeyAdapterTogglePower, !powered)
...
func (v *viewActions) discoverable(set ...string) bool {
	...
	v.rv.menu.setItemToggle(keybindings.KeyAdapterToggleDiscoverable, !discoverable)
...
func (v *viewActions) pairable(set ...string) bool {
	...
	v.rv.menu.setItemToggle(keybindings.KeyAdapterTogglePairable, !pairable)
...
func (v *viewActions) scan(set ...string) bool {
	...
	v.rv.menu.setItemToggle(keybindings.KeyAdapterToggleScan, !discover)

	return true
}

// changeAdapter launches a popup with the adapters list.
func (v *viewActions) changeAdapter(set ...string) bool {
...
func (v *viewActions) progress(set ...string) bool {
	v.rv.app.InstantDraw(func() {
		v.rv.progress.show()
	})
...
func (v *viewActions) quit(set ...string) bool {
...
// initPower sets the oncreate handler for the power submenu option.
func (v *viewActions) initPower(set ...string) bool {
	props, err := v.rv.adapter.currentSession().Properties()

	return err == nil && props.Powered
}

// initDiscoverable sets the oncreate handler for the discoverable submenu option
func (v *viewActions) initDiscoverable(set ...string) bool {
	props, err := v.rv.adapter.currentSession().Properties()

	return err == nil && props.Discoverable
}

// initPairable sets the oncreate handler for the pairable submenu option.
func (v *viewActions) initPairable(set ...string) bool {
	props, err := v.rv.adapter.currentSession().Properties()

	return err == nil && props.Pairable
}

// initConnect sets the oncreate handler for the connect submenu option.
func (v *viewActions) initConnect(set ...string) bool {
...
// initTrust sets the oncreate handler for the trust submenu option.
func (v *viewActions) initTrust(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
// initBlock sets the oncreate handler for the block submenu option.
func (v *viewActions) initBlock(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) visibleSend(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) visibleNetwork(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) visibleProfile(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) visiblePlayer(set ...string) bool {
	device := v.rv.device.getSelection(false)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) connect(set ...string) bool {
	...
	v.rv.menu.setItemToggle(keybindings.KeyDeviceConnect, !device.Connected)

	return true
}

// pair retrieves the selected device, and attempts to pair with it.
func (v *viewActions) pair(set ...string) bool {
	device := v.rv.device.getSelection(true)
	if device.Address.IsNil() {
		return false
	}
...
func (v *viewActions) trust(set ...string) bool {
	device := v.rv.device.getSelection(true)
	if device.Address.IsNil() {
		return false
	}
	...
	v.rv.menu.setItemToggle(keybindings.KeyDeviceTrust, !device.Trusted)

	return true
}

// block retrieves the selected device, and toggles its block property.
func (v *viewActions) block(set ...string) bool {
	device := v.rv.device.getSelection(true)
	if device.Address.IsNil() {
		return false
	}
	...
	v.rv.menu.setItemToggle(keybindings.KeyDeviceBlock, !device.Blocked)
...
func (v *viewActions) send(set ...string) bool {
	device := v.rv.device.getSelection(true)
...
func (v *viewActions) networkAP(set ...string) bool {
	v.rv.app.InstantDraw(func() {
...
func (v *viewActions) profiles(set ...string) bool {
	v.rv.app.InstantDraw(func() {
...
func (v *viewActions) showplayer(set ...string) bool {
	v.rv.player.show()
...
func (v *viewActions) hideplayer(set ...string) bool {
	v.rv.player.close()
...
func (v *viewActions) info(set ...string) bool {
	v.rv.app.InstantDraw(func() {
		v.rv.device.getInfo()
	})
...
func (v *viewActions) remove(set ...string) bool {
	device := v.rv.device.getSelection(true)
	if device.Address.IsNil() {
		return false
	}
